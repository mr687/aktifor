...
if( ($_mtphr_dnt_total_ticks > 1) && $_mtphr_dnt_mode == 'rotate' ) {
	...
	if( isset($_mtphr_dnt_rotate_directional_nav) && $_mtphr_dnt_rotate_directional_nav ) {
		...
		echo '<a class="mtphr-dnt-nav mtphr-dnt-nav-prev'.$hide.'" href="#" rel="nofollow">'.apply_filters( 'mtphr_dnt_direction_nav_prev', '<i class="dashicons-before dashicons-arrow-left-alt2"></i>' ).'</a>';
		echo '<a class="mtphr-dnt-nav mtphr-dnt-nav-next'.$hide.'" href="#" rel="nofollow">'.apply_filters( 'mtphr_dnt_direction_nav_next', '<i class="dashicons-before dashicons-arrow-right-alt2"></i>' ).'</a>';
	}
}